...
{{- include "commons.getValue" (dict "Values" $.Values "Chart" $.Chart "Release" $.Release "component" $.global.postgres "value" "__addons__postgres__username") }}
{{- end }}
{{- end }}
...
{{- if .Values.addons.postgres.enabled -}}
{{- include "commons.getValue" (dict "Values" $.Values "Chart" $.Chart "Release" $.Release "component" $.global.postgres "value" "__addons__postgres__databasse") }}
{{- end }}
{{- end }}
...
{{- if .Values.addons.postgres.enabled -}}
{{- include "commons.getValue" (dict "Values" $.Values "Chart" $.Chart "Release" $.Release "component" $.global.postgres "value" "__addons__postgres__password") }}
{{- end -}}
{{- end }}
...
{{- if .Values.addons.postgres.enabled -}}
{{- include "commons.getValue" (dict "Values" $.Values "Chart" $.Chart "Release" $.Release "component" $.global.postgres "value" "__addons__postgres__host") }}
{{- end -}}
{{- end }}